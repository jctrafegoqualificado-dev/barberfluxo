    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <header className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/cadastro" className="px-4 py-2 rounded-lg text-sm bg-primary hover:bg-primary/90 font-medium transition-colors">Começar grátis</Link>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <div className="flex gap-4 justify-center">
          <Link href="/cadastro" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-primary hover:bg-primary/90 font-semibold text-lg transition-colors">
