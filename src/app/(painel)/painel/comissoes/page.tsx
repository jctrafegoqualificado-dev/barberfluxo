...
interface BarberComissao {
  ...
  assinatura: { servicos: number; ticketMedio: number; comissao: number };
      ...
      {barber.paid ? (
        ...
        <div className="px-5 py-3 bg-primary/10 border-t border-primary/20">
          <div className="flex items-center justify-between mb-1">
            <div>
              <p className="text-xs text-primary/90 font-medium">Comissão bruta</p>
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-black text-primary/90">{formatCurrency(barber.liquidoAPagar)}</p>
            </div>
          </div>
          <div className="flex gap-2 mt-2">
            ...
            <button onClick={handlePay} disabled={paying || barber.liquidoAPagar === 0}
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary text-white text-xs font-semibold hover:bg-primary/90 transition-colors disabled:opacity-40">
              <Check className="w-3.5 h-3.5" />
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-sm text-blue-700">
        ...
        <ul className="space-y-0.5 text-xs text-blue-600">
          ...
          <li>• <strong>Assinatura</strong> — 50% do faturamento total é dividido pelo número de atendimentos, gerando um Ticket Médio pago por corte realizado.</li>
        </ul>
      </div>
